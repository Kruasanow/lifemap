...
python3 init_db.py
sudo -u postgres psql -d $DBNAME -c "INSERT INTO maps (city,city_name,filename) VALUES ('spb','Санкт-Петербург','spb.png');"
sudo -u postgres psql -d $DBNAME -c "INSERT INTO maps (city,city_name,filename) VALUES ('bg','Белая Глина','bg.png');"
